...
class Ad
{
     ...
     * maxMessage="Le titre doit faire au plus 255 caractères !")
     */
    private $title;
    ...
    /**
     * @ORM\Column(type="text")
     * @Assert\Length(min=100, minMessage="Le contenu doit faire plus de 20 caractères !")
     */
    private $content;
    ...
    /**
     * Permet de récupérer le commentaire d'une annonce ar rapprt à son auteur
     *
     * @param User $author
     * @return Comment|null
     */
    ...
    /**
     * Permet de calculer la moyenne des notes obtenue pour une annonce
     *
     * @return float
     */
     ...
     *
     * @return array Tableau des jours indisponibles
     */
